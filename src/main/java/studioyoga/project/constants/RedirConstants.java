...
public class RedirConstants {
	...
	public static final String REDIRECT_ADMIN_RESERVATIONS_CREATE = "redirect:/admin/reservations/create";
	public static final String REDIRECT_ADMIN_RESERVATIONS_EDIT = "redirect:/admin/reservations/edit";
	public static final String REDIRECT_ADMIN_RESERVATIONS_DELETE = "redirect:/admin/reservations/delete";
	public static final String REDIRECT_ADMIN_USERS_CREATE = "redirect:/admin/users/new";
